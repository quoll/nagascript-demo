...
var G__21520 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__21520;
continue;
} else {
return ch;
...
var vec__21521 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__21521,(0),null);
return (match === s);
});
...
var len__4499__auto___21526 = arguments.length;
var i__4500__auto___21527 = (0);
while(true){
if((i__4500__auto___21527 < len__4499__auto___21526)){
args__4502__auto__.push((arguments[i__4500__auto___21527]));

var G__21528 = (i__4500__auto___21527 + (1));
i__4500__auto___21527 = G__21528;
continue;
} else {
}
break;
...
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq21524){
var G__21525 = cljs.core.first.call(null,seq21524);
var seq21524__$1 = cljs.core.next.call(null,seq21524);
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic(G__21525,seq21524__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__21529__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__21529 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__21530__i = 0, G__21530__a = new Array(arguments.length -  1);
while (G__21530__i < G__21530__a.length) {G__21530__a[G__21530__i] = arguments[G__21530__i + 1]; ++G__21530__i;}
  _ = new cljs.core.IndexedSeq(G__21530__a,0,null);
} 
return G__21529__delegate.call(this,rdr,_);};
G__21529.cljs$lang$maxFixedArity = 1;
G__21529.cljs$lang$applyTo = (function (arglist__21531){
var rdr = cljs.core.first(arglist__21531);
var _ = cljs.core.rest(arglist__21531);
return G__21529__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1525291300856
