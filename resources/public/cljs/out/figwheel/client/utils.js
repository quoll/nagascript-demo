...
var or__3924__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj44765 = {"detail":data__$1};
return obj44765;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__3913__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__3913__auto__)){
var and__3913__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__44772 = cljs.core._EQ_;
var expr__44773 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__44772.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__44773))){
return ((function (pred__44772,expr__44773){
return (function (p1__44766_SHARP_){
return console.warn(p1__44766_SHARP_);
});
;})(pred__44772,expr__44773))
} else {
if(cljs.core.truth_(pred__44772.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__44773))){
return ((function (pred__44772,expr__44773){
return (function (p1__44767_SHARP_){
return console.debug(p1__44767_SHARP_);
});
;})(pred__44772,expr__44773))
} else {
if(cljs.core.truth_(pred__44772.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__44773))){
return ((function (pred__44772,expr__44773){
return (function (p1__44768_SHARP_){
return console.error(p1__44768_SHARP_);
});
;})(pred__44772,expr__44773))
} else {
return ((function (pred__44772,expr__44773){
return (function (p1__44769_SHARP_){
return console.log(p1__44769_SHARP_);
});
;})(pred__44772,expr__44773))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__44776){
...
var opts = map__44777__$1;
var eval_fn = cljs.core.get.call(null,map__44777__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__44779_SHARP_){
return new_def.callback(p1__44779_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__44781,(0),null);
var v = cljs.core.nth.call(null,vec__44781,(1),null);
...
if(cljs.core.truth_((function (){var and__3913__auto__ = typeof localStorage !== 'undefined';
...
}catch (e44786){if((e44786 instanceof Error)){
var e = e44786;
return not_found;
} else {
throw e44786;
...
//# sourceMappingURL=utils.js.map?rel=1525291346790
