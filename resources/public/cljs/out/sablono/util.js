...
var x__4213__auto__ = (((x == null))?null:x);
var m__4214__auto__ = (sablono.util.to_str[goog.typeOf(x__4213__auto__)]);
if(!((m__4214__auto__ == null))){
return m__4214__auto__.call(null,x);
} else {
var m__4214__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__4214__auto____$1 == null))){
return m__4214__auto____$1.call(null,x);
} else {
...
var x__4213__auto__ = (((x == null))?null:x);
var m__4214__auto__ = (sablono.util.to_uri[goog.typeOf(x__4213__auto__)]);
if(!((m__4214__auto__ == null))){
return m__4214__auto__.call(null,x);
} else {
var m__4214__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__4214__auto____$1 == null))){
return m__4214__auto____$1.call(null,x);
} else {
...
var len__4499__auto___33849 = arguments.length;
var i__4500__auto___33850 = (0);
while(true){
if((i__4500__auto___33850 < len__4499__auto___33849)){
args__4502__auto__.push((arguments[i__4500__auto___33850]));

var G__33851 = (i__4500__auto___33850 + (1));
i__4500__auto___33850 = G__33851;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq33848){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33848));
});
...
var vec__33852 = cljs.core.name.call(null,k).split("-");
var seq__33853 = cljs.core.seq.call(null,vec__33852);
var first__33854 = cljs.core.first.call(null,seq__33853);
var seq__33853__$1 = cljs.core.next.call(null,seq__33853);
var first_word = first__33854;
var words = seq__33853__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__33855){
...
return cljs.core.update.call(null,G__33859,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__33859;
}
} else {
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__3924__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1525291334771
