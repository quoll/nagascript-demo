...
:c);
var temp__5455__auto__ = new cljs.core.Keyword(null,"wrap-error","wrap-error",536732809).cljs$core$IFn$_invoke$arity$1(o);
if(cljs.core.truth_(temp__5455__auto__)){
var wrap_error = temp__5455__auto__;
return ((function (wrap_error,temp__5455__auto__,g,c,step){
return (function (x){
var res = step.call(null,x);
var temp__5455__auto____$1 = schema.utils.error_val.call(null,res);
if(cljs.core.truth_(temp__5455__auto____$1)){
var e = temp__5455__auto____$1;
return schema.utils.error.call(null,wrap_error.call(null,e));
} else {
return res;
}
});
;})(wrap_error,temp__5455__auto__,g,c,step))
} else {
return step;
}
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this__4174__auto__,k__4175__auto__){
var self__ = this;
var this__4174__auto____$1 = this;
return this__4174__auto____$1.cljs$core$ILookup$_lookup$arity$3(null,k__4175__auto__,null);
});

schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4176__auto__,k27966,else__4177__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k27966,else__4177__auto__);
...
var or__3924__auto____$1 = self__.post.call(null,(cljs.core.truth_(new cljs.core.Keyword(null,"return-walked?","return-walked?",-1684646015).cljs$core$IFn$_invoke$arity$1(params))?v:x));
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (this__4188__auto__,writer__4189__auto__,opts__4190__auto__){
var self__ = this;
...
;
return cljs.core.pr_sequential_writer.call(null,writer__4189__auto__,pr_pair__4191__auto__,"#schema.spec.variant.VariantSpec{",", ","}",opts__4190__auto__,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"pre","pre",2118456869),self__.pre],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"options","options",99638489),self__.options],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"err-f","err-f",651620941),self__.err_f],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"post","post",269697687),self__.post],null))], null),self__.__extmap));
});

schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__27965){
var self__ = this;
var G__27965__$1 = this;
return (new cljs.core.RecordIter((0),G__27965__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});

schema.spec.variant.VariantSpec.prototype.cljs$core$IMeta$_meta$arity$1 = (function (this__4172__auto__){
var self__ = this;
var this__4172__auto____$1 = this;
return self__.__meta;
});

schema.spec.variant.VariantSpec.prototype.cljs$core$ICloneable$_clone$arity$1 = (function (this__4169__auto__){
var self__ = this;
...
schema.spec.variant.VariantSpec.prototype.cljs$core$ICounted$_count$arity$1 = (function (this__4178__auto__){
var self__ = this;
var this__4178__auto____$1 = this;
return (4 + cljs.core.count.call(null,self__.__extmap));
});

schema.spec.variant.VariantSpec.prototype.cljs$core$IHash$_hash$arity$1 = (function (this__4170__auto__){
var self__ = this;
...
return (-1524878868 ^ cljs.core.hash_unordered_coll.call(null,coll__4171__auto__));
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this27967,other27968){
var self__ = this;
var this27967__$1 = this;
return ((!((other27968 == null))) && ((this27967__$1.constructor === other27968.constructor)) && (cljs.core._EQ_.call(null,this27967__$1.pre,other27968.pre)) && (cljs.core._EQ_.call(null,this27967__$1.options,other27968.options)) && (cljs.core._EQ_.call(null,this27967__$1.err_f,other27968.err_f)) && (cljs.core._EQ_.call(null,this27967__$1.post,other27968.post)) && (cljs.core._EQ_.call(null,this27967__$1.__extmap,other27968.__extmap)));
});

schema.spec.variant.VariantSpec.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__4183__auto__,k__4184__auto__){
var self__ = this;
var this__4183__auto____$1 = this;
if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"pre","pre",2118456869),null,new cljs.core.Keyword(null,"err-f","err-f",651620941),null,new cljs.core.Keyword(null,"post","post",269697687),null,new cljs.core.Keyword(null,"options","options",99638489),null], null), null),k__4184__auto__)){
...
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__4184__auto__)),null));
}
});

schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4181__auto__,k__4182__auto__,G__27965){
var self__ = this;
var this__4181__auto____$1 = this;
var pred__27971 = cljs.core.keyword_identical_QMARK_;
var expr__27972 = k__4182__auto__;
if(cljs.core.truth_(pred__27971.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__27972))){
return (new schema.spec.variant.VariantSpec(G__27965,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__27971.call(null,new cljs.core.Keyword(null,"options","options",99638489),expr__27972))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__27965,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__27971.call(null,new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__27972))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__27965,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__27971.call(null,new cljs.core.Keyword(null,"post","post",269697687),expr__27972))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__27965,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4182__auto__,G__27965),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$ISeqable$_seq$arity$1 = (function (this__4186__auto__){
var self__ = this;
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4173__auto__,G__27965){
var self__ = this;
var this__4173__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__27965,self__.__extmap,self__.__hash));
});

schema.spec.variant.VariantSpec.prototype.cljs$core$ICollection$_conj$arity$2 = (function (this__4179__auto__,entry__4180__auto__){
var self__ = this;
...
schema.spec.variant.VariantSpec.cljs$lang$ctorPrSeq = (function (this__4210__auto__){
return (new cljs.core.List(null,"schema.spec.variant/VariantSpec",null,(1),null));
});

schema.spec.variant.VariantSpec.cljs$lang$ctorPrWriter = (function (this__4210__auto__,writer__4211__auto__){
return cljs.core._write.call(null,writer__4211__auto__,"schema.spec.variant/VariantSpec");
});
 ...
 */
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__27969){
return (new schema.spec.variant.VariantSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__27969),new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__27969),new cljs.core.Keyword(null,"err-f","err-f",651620941).cljs$core$IFn$_invoke$arity$1(G__27969),new cljs.core.Keyword(null,"post","post",269697687).cljs$core$IFn$_invoke$arity$1(G__27969),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__27969,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687))),null));
});
...
if(cljs.core.truth_((function (){var or__3924__auto__ = err_f;
if(cljs.core.truth_(or__3924__auto__)){
return or__3924__auto__;
} else {
...
//# sourceMappingURL=variant.js.map?rel=1525291309581
