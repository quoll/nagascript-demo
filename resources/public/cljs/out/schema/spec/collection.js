...
var G__27929 = cljs.core.first.call(null,e);
...
if(cljs.core.not_any_QMARK_.call(null,(function (p1__27931_SHARP_){
return ((cljs.core.vector_QMARK_.call(null,p1__27931_SHARP_)) && (cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__27931_SHARP_),new cljs.core.Keyword("schema.spec.collection","remaining","schema.spec.collection/remaining",-421177821))));
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this__4174__auto__,k__4175__auto__){
var self__ = this;
var this__4174__auto____$1 = this;
return this__4174__auto____$1.cljs$core$ILookup$_lookup$arity$3(null,k__4175__auto__,null);
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4176__auto__,k27933,else__4177__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k27933,else__4177__auto__);
...
if(cljs.core.truth_((function (){var or__3924__auto____$1 = cljs.core.seq.call(null,remaining);
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (this__4188__auto__,writer__4189__auto__,opts__4190__auto__){
var self__ = this;
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ICounted$_count$arity$1 = (function (this__4178__auto__){
var self__ = this;
var this__4178__auto____$1 = this;
return (4 + cljs.core.count.call(null,self__.__extmap));
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$IHash$_hash$arity$1 = (function (this__4170__auto__){
var self__ = this;
...
return (1800698765 ^ cljs.core.hash_unordered_coll.call(null,coll__4171__auto__));
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this27934,other27935){
var self__ = this;
var this27934__$1 = this;
return ((!((other27935 == null))) && ((this27934__$1.constructor === other27935.constructor)) && (cljs.core._EQ_.call(null,this27934__$1.pre,other27935.pre)) && (cljs.core._EQ_.call(null,this27934__$1.constructor,other27935.constructor)) && (cljs.core._EQ_.call(null,this27934__$1.elements,other27935.elements)) && (cljs.core._EQ_.call(null,this27934__$1.on_error,other27935.on_error)) && (cljs.core._EQ_.call(null,this27934__$1.__extmap,other27935.__extmap)));
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__4183__auto__,k__4184__auto__){
var self__ = this;
var this__4183__auto____$1 = this;
if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"pre","pre",2118456869),null,new cljs.core.Keyword(null,"elements","elements",657646735),null,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),null,new cljs.core.Keyword(null,"on-error","on-error",1728533530),null], null), null),k__4184__auto__)){
...
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__4184__auto__)),null));
}
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4181__auto__,k__4182__auto__,G__27932){
var self__ = this;
var this__4181__auto____$1 = this;
var pred__27938 = cljs.core.keyword_identical_QMARK_;
var expr__27939 = k__4182__auto__;
if(cljs.core.truth_(pred__27938.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__27939))){
return (new schema.spec.collection.CollectionSpec(G__27932,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__27938.call(null,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),expr__27939))){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__27932,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__27938.call(null,new cljs.core.Keyword(null,"elements","elements",657646735),expr__27939))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__27932,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__27938.call(null,new cljs.core.Keyword(null,"on-error","on-error",1728533530),expr__27939))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__27932,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4182__auto__,G__27932),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ISeqable$_seq$arity$1 = (function (this__4186__auto__){
var self__ = this;
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4173__auto__,G__27932){
var self__ = this;
var this__4173__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__27932,self__.__extmap,self__.__hash));
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$ICollection$_conj$arity$2 = (function (this__4179__auto__,entry__4180__auto__){
var self__ = this;
...
schema.spec.collection.CollectionSpec.cljs$lang$ctorPrSeq = (function (this__4210__auto__){
return (new cljs.core.List(null,"schema.spec.collection/CollectionSpec",null,(1),null));
});

schema.spec.collection.CollectionSpec.cljs$lang$ctorPrWriter = (function (this__4210__auto__,writer__4211__auto__){
return cljs.core._write.call(null,writer__4211__auto__,"schema.spec.collection/CollectionSpec");
});
 ...
 */
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__27936){
return (new schema.spec.collection.CollectionSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__27936),new cljs.core.Keyword(null,"constructor","constructor",-1953928811).cljs$core$IFn$_invoke$arity$1(G__27936),new cljs.core.Keyword(null,"elements","elements",657646735).cljs$core$IFn$_invoke$arity$1(G__27936),new cljs.core.Keyword(null,"on-error","on-error",1728533530).cljs$core$IFn$_invoke$arity$1(G__27936),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__27936,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"constructor","constructor",-1953928811),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530))),null));
});
...
var len__4499__auto___27943 = arguments.length;
var i__4500__auto___27944 = (0);
while(true){
if((i__4500__auto___27944 < len__4499__auto___27943)){
args__4502__auto__.push((arguments[i__4500__auto___27944]));

var G__27945 = (i__4500__auto___27944 + (1));
i__4500__auto___27944 = G__27945;
continue;
} else {
}
break;
...
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(argseq__4503__auto__);
});
...
schema.spec.collection.optional.cljs$lang$applyTo = (function (seq27942){
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27942));
});
...
//# sourceMappingURL=collection.js.map?rel=1525291309408
