...
var m__4214__auto__ = (schema.spec.core.subschemas[goog.typeOf(x__4213__auto__)]);
if(!((m__4214__auto__ == null))){
return m__4214__auto__.call(null,this$);
} else {
var m__4214__auto____$1 = (schema.spec.core.subschemas["_"]);
...
var x__4213__auto__ = (((this$ == null))?null:this$);
var m__4214__auto__ = (schema.spec.core.checker[goog.typeOf(x__4213__auto__)]);
if(!((m__4214__auto__ == null))){
return m__4214__auto__.call(null,this$,params);
} else {
var m__4214__auto____$1 = (schema.spec.core.checker["_"]);
if(!((m__4214__auto____$1 == null))){
return m__4214__auto____$1.call(null,this$,params);
} else {
...
return (function (x){
var temp__5457__auto__ = (function (){try{if(cljs.core.truth_(p.call(null,x))){
return null;
} else {
...
var reason = temp__5457__auto__;
return schema.utils.error.call(null,schema.utils.make_ValidationError.call(null,s,x,(new cljs.core.Delay(((function (reason,temp__5457__auto__){
return (function (){
return err_f.call(null,schema.utils.value_name.call(null,x));
});})(reason,temp__5457__auto__))
,null)),reason));
} else {
return null;
}
...
var temp__5455__auto__ = cljs.core.deref.call(null,cache).call(null,cache_key);
...
return wrap_recursive_delay.call(null,(new cljs.core.Delay(((function (w,temp__5455__auto__){
return (function (){
return cljs.core.deref.call(null,cache).call(null,cache_key);
});})(w,temp__5455__auto__))
,null)));
} else {
return w;
}
 ...
 */
schema.spec.core.sub_checker = (function schema$spec$core$sub_checker(p__27902,p__27903){
var map__27904 = p__27902;
...
var schema__$1 = cljs.core.get.call(null,map__27904__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var error_wrap = cljs.core.get.call(null,map__27904__$1,new cljs.core.Keyword(null,"error-wrap","error-wrap",-1295833514));
var map__27905 = p__27903;
...
var params = map__27905__$1;
var subschema_checker = cljs.core.get.call(null,map__27905__$1,new cljs.core.Keyword(null,"subschema-checker","subschema-checker",1137701360));
var cache = cljs.core.get.call(null,map__27905__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var sub = schema.spec.core.with_cache.call(null,cache,schema__$1,((function (map__27904,map__27904__$1,schema__$1,error_wrap,map__27905,map__27905__$1,params,subschema_checker,cache){
return (function (d){
return ((function (map__27904,map__27904__$1,schema__$1,error_wrap,map__27905,map__27905__$1,params,subschema_checker,cache){
return (function (x){
return cljs.core.deref.call(null,d).call(null,x);
});
;})(map__27904,map__27904__$1,schema__$1,error_wrap,map__27905,map__27905__$1,params,subschema_checker,cache))
});})(map__27904,map__27904__$1,schema__$1,error_wrap,map__27905,map__27905__$1,params,subschema_checker,cache))
,((function (map__27904,map__27904__$1,schema__$1,error_wrap,map__27905,map__27905__$1,params,subschema_checker,cache){
return (function (){
return subschema_checker.call(null,schema__$1,params);
});})(map__27904,map__27904__$1,schema__$1,error_wrap,map__27905,map__27905__$1,params,subschema_checker,cache))
);
if(cljs.core.truth_(error_wrap)){
return ((function (sub,map__27904,map__27904__$1,schema__$1,error_wrap,map__27905,map__27905__$1,params,subschema_checker,cache){
return (function (x){
var res = sub.call(null,x);
var temp__5455__auto__ = schema.utils.error_val.call(null,res);
if(cljs.core.truth_(temp__5455__auto__)){
...
;})(sub,map__27904,map__27904__$1,schema__$1,error_wrap,map__27905,map__27905__$1,params,subschema_checker,cache))
} else {
return sub;
}
});

//# sourceMappingURL=core.js.map?rel=1525291309227
