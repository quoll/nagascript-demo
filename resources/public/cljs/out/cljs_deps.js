...
goog.addDependency("../naga/schema/store_structs.js", ['naga.schema.store_structs'], ['schema.core', 'cljs.core']);
goog.addDependency("../naga/store.js", ['naga.store'], ['schema.core', 'cljs.core']);
goog.addDependency("../naga/storage/store_util.js", ['naga.storage.store_util'], ['schema.core', 'cljs.core', 'naga.schema.store_structs', 'naga.store']);
...
goog.addDependency("../asami/index.js", ['asami.index'], ['schema.core', 'cljs.core', 'naga.schema.store_structs']);
goog.addDependency("../cljs/spec/gen/alpha.js", ['cljs.spec.gen.alpha'], ['cljs.core']);
goog.addDependency("../naga/data.js", ['naga.data'], ['schema.core', 'cljs.core', 'clojure.string', 'naga.store']);
...
goog.addDependency("../naga/schema/structs.js", ['naga.schema.structs'], ['schema.core', 'cljs.core', 'naga.schema.store_structs']);
...
goog.addDependency("../naga/util.js", ['naga.util'], ['schema.core', 'cljs.js', 'cljs.core']);
goog.addDependency("../naga/rules.js", ['naga.rules'], ['schema.core', 'cljs.core', 'clojure.set', 'naga.schema.structs', 'naga.schema.store_structs', 'naga.util']);
goog.addDependency("../the/parsatron.js", ['the.parsatron'], ['cljs.core', 'clojure.string']);
...
goog.addDependency("../naga/lang/basic.js", ['naga.lang.basic'], ['cljs.core', 'naga.schema.store_structs', 'the.parsatron', 'clojure.string']);
goog.addDependency("../naga/lang/expression.js", ['naga.lang.expression'], ['cljs.core', 'naga.lang.basic', 'the.parsatron']);
goog.addDependency("../naga/lang/parser.js", ['naga.lang.parser'], ['naga.lang.expression', 'cljs.core', 'naga.lang.basic', 'the.parsatron']);
goog.addDependency("../naga/lang/pabu.js", ['naga.lang.pabu'], ['schema.core', 'naga.rules', 'cljs.core', 'naga.lang.parser', 'naga.schema.structs', 'naga.schema.store_structs', 'naga.util', 'clojure.string']);
goog.addDependency("../naga/store_registry.js", ['naga.store_registry'], ['cljs.core']);
goog.addDependency("../asami/core.js", ['asami.core'], ['asami.index', 'schema.core', 'naga.storage.store_util', 'cljs.core', 'clojure.set', 'naga.schema.store_structs', 'naga.util', 'naga.store_registry', 'clojure.string', 'naga.store']);
...
goog.addDependency("../naga/queue.js", ['naga.queue'], ['schema.core', 'cljs.core']);
goog.addDependency("../naga/engine.js", ['naga.engine'], ['schema.core', 'cljs.core', 'naga.queue', 'naga.schema.structs', 'naga.schema.store_structs', 'naga.util', 'naga.store_registry', 'naga.store']);
goog.addDependency("../data/components.js", ['data.components'], ['naga.lang.pabu', 'asami.core', 'naga.rules', 'cljs.core', 'sablono.core', 'naga.store_registry', 'naga.engine', 'clojure.string', 'naga.data', 'naga.store']);
goog.addDependency("../data/core.js", ['data.core'], ['data.components', 'cljs.core', 'sablono.core', 'react_dom']);
...
goog.addDependency("../figwheel/connect/build_figwheel.js", ['figwheel.connect.build_figwheel'], ['data.core', 'cljs.core', 'figwheel.client', 'figwheel.client.utils']);
